      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <div className="h-[360px] rounded-[1.75rem] border border-gray-200/60 bg-[#F4F4F4] pt-7 px-7 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 flex justify-center items-end min-h-0">
              <div className="w-[260px] bg-white rounded-t-[2.4rem] border border-b-0 border-gray-200 shadow-[0_0_30px_rgba(0,0,0,0.12)] flex flex-col overflow-hidden">
                {/* Notch area */}
                ...
                <div className="flex flex-col items-center px-6 py-4 gap-2.5">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-[11px] text-gray-400 mt-0.5">Créateur de contenu</p>
                  </div>
                  ...
                  {/* Members count */}
                  <div className="text-center">
                    <p className="text-xs font-bold text-gray-900">4.8K membres</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <FadeIn delay={0.5} className="text-center mt-16">
          <div className="inline-flex items-center gap-3">
            <div className="w-8 h-px bg-gradient-to-r from-transparent to-gray-200" />
            <p className="text-base text-gray-400">
              Voici comment ça marche, en 3 étapes.
            </p>
            <div className="w-8 h-px bg-gradient-to-l from-transparent to-gray-200" />
          </div>
        </FadeIn>
      </div>
    </section>
